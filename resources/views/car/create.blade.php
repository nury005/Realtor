@extends('layouts.app')
@section('title') @lang('app.estate') - @lang('app.create') @endsection
@section('content')
    <div class="container-xxl py-3">
        <div class="d-block h3 text-dark fw-bold text-center border-bottom py-2 mb-3">
            @lang('app.estate') - @lang('app.add')
        </div>
        <div class="row justify-content-center">
            <form action="{{ route('estates.store') }}" method="post" enctype="multipart/form-data" class="col-md-6 col-lg-4">
                @csrf
